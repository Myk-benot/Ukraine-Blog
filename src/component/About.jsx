  ...
  return (
    <>
      <div className="about-div">
        ...
        <p className="about-text">
          "Within our global tapestry emerges a soul, Ukrainian and wondrous to
          behold. A blend of beauty, care, and strength untold, she mirrors a
          nation's resilience, a story of old. Who is she, this embodiment of
          grace, a living riddle in this vast embrace?"
        </p>
        <p className="about-text">
          ...
          In a world that often seems vast, we discover our own universe in one
          another, proving that love knows no boundaries."
        </p>
      </div>
    </>
  );
